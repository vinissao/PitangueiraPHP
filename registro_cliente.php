...
if (isset($_POST['RegistrarCliente'])) {
    ...
    $email = ($_POST['email']);
    $cadastro_usuario = mysqli_query(
        $conexao,
        "insert into tb_clientes (nome_cliente, telefone, email, dataRegistro) values ('$nome','$telefone','$email',now())"
    );
}
            ...
            <form method="POST" action="registro_cliente.php">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Registro de Cliente</h6>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="nome" id="nome"" placeholder=" nome" required>
                            <label for="floatingText">Nome Completo</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="phone" class="form-control" name="telefone" id="telefone" placeholder="telefone" required>
                        ...
                        <div class="m-n2">
                            ...
                            <form action="registro_cliente.php">
                                <input type="submit" name="RegistrarCliente" id="RegistrarCliente" class="btn btn-primary m-2" value="Registrar Cliente" />
                            </form>
                        </div>
