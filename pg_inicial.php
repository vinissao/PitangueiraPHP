...
//$sql = 'select * from tb_atendimento order by id_atendimento';
//$usuario = $_SESSION['usuario'];
//$funcao_usuario = "select funcao from tb_tecnico where usuario = '$usuario)'";
//$row = mysql_fetch_row($funcao_usuario);
